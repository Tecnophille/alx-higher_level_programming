...
Project done during **Full Stack Software Engineering** at **ALX**. Learn about object oriented programming (OOP), classes, objects, instances, methods and attributes in **Python**.
